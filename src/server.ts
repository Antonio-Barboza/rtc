...
export class Server {
  ...
  private privateKey = fs.readFileSync("sslcert/server.key", "utf8");
  private certificate = fs.readFileSync("sslcert/server.crt", "utf8");
  ...
  private initialize(): void {
    ...
    this.io = socketIO(this.httpServer).listen(this.httpServer);
